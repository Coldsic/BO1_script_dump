...
mainDebug()
{
	debug_replay("File: _debug.gsc. Function: mainDebug()\n");
...
//	thread debuggoalpos();
	...
	debug_replay("File: _debug.gsc. Function: mainDebug() - COMPLETE\n");
}
#/
...
{
	/#
	debug_replay("File: _debug.gsc. Function: debugDvars()\n");
	...
	debug_replay("File: _debug.gsc. Function: debugDvars() - WAIT FINISHED\n");
...
//	thread debug_character_count();
	...
	for( ;; )
	{
		debug_replay("File: _debug.gsc. Function: debugDvars() - INNNER LOOP START\n");
		...
		{
			anim.defaultException = get_overloaded_func( "animscripts\init", "empty" );
		...
		debug_replay("File: _debug.gsc. Function: debugDvars() - INNNER LOOP START WAIT 0.05\n");
		
		wait( 0.05 );
		
		debug_replay("File: _debug.gsc. Function: debugDvars() - INNNER LOOP STOP WAIT 0.05\n");

		debug_replay("File: _debug.gsc. Function: debugDvars() - INNNER LOOP END\n");
	}
	
	debug_replay("File: _debug.gsc. Function: debugDvars() - COMPLETE\n");
	#/
}
...
debug_reflection_buttons()
{
	...
	{
		debug_replay("File: _debug.gsc. Function: debug_reflection_buttons() - INNER LOOP START\n");
...
//			}
		...
		debug_replay("File: _debug.gsc. Function: debug_reflection_buttons() - INNER LOOP END\n");
...
lastSightPosWatch()
{
	...
	for( ;; )
	{
		...
		debug_replay("File: _debug.gsc. Function: lastSightPosWatch() - INNER LOOP START\n");
		
		num = GetDvarInt( #"lastsightpos" );
		if( !num )
		{
			debug_replay("File: _debug.gsc. Function: lastSightPosWatch() - INNER LOOP END EARLY 1\n");
			continue;
		}
		...
		if( !isalive( guy ) )
		{
			debug_replay("File: _debug.gsc. Function: lastSightPosWatch() - INNER LOOP END EARLY 2\n");
			continue;
		}
		...
		for( ;; )
		{
			debug_replay("File: _debug.gsc. Function: lastSightPosWatch() - INNER INNER LOOP START\n");
			...
			debug_replay("File: _debug.gsc. Function: lastSightPosWatch() - INNER INNER LOOP END\n");
			
			wait( 0.05 );
		}
		
		debug_replay("File: _debug.gsc. Function: lastSightPosWatch() - INNER LOOP END\n");
	}
	#/
}
...
{	
	/#
	debug_replay("File: _debug.gsc. Function: updateMinimapSetting()\n");
	#/
	...
	/#
	debug_replay("File: _debug.gsc. Function: updateMinimapSetting() - COMPLETE\n");
	#/
}
...
{
	/#
	debug_replay("File: _debug.gsc. Function: draw_animsounds_in_hud()\n");
	#/
	...
	/#
	debug_replay("File: _debug.gsc. Function: draw_animsounds_in_hud() - COMPLETE\n");
	#/
}
...
{
	/#
	debug_replay("File: _debug.gsc. Function: debug_animSoundTagSelected()\n");
	...
	if( tag == "" )
	{
		...
		debug_replay("File: _debug.gsc. Function: debug_animSoundTagSelected() - COMPLETE EARLY\n");
		return;
	}
	...
	debug_replay("File: _debug.gsc. Function: debug_animSoundTagSelected() - COMPLETE\n");
	#/
}
...
{
	/#
	debug_replay("File: _debug.gsc. Function: spawn_anywhere()\n");
	#/
	...
	/#
	debug_replay("File: _debug.gsc. Function: spawn_anywhere() - COMPLETE\n");
	#/
}
...
ai_puppet_manager()
{
	...
	while(1)
	{
		if( self ButtonPressed("BUTTON_RTRIG") ) // shoot
		{
