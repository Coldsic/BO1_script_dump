...
hiding_door_guy_grenade_throw( guy )
{
	...
	velocity = vector_scale( vector, strength );
...
hiding_door_death()
{
	...
	self.hiding_door.door_org delaythread( 0.05, ::anim_single_aligned, guys, death_anim );
...
hiding_door_actor_damage( inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, sHitLoc, modelIndex, psOffsetTime )
{
