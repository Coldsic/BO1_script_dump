...
ai_ride_and_shoot()
{
	...
	while(1)
	{
		...
		if( IsDefined(self.shootEnt) )
		{
			...
			//recordLine( shootFromPos, shootFromPos + vector_scale(facingVector, 100), (0,0,1), "Script", self );
...
//
//		recordLine( muzzle, muzzle + vector_scale(facingVector, 500), (0,1,0), "Script", self );
