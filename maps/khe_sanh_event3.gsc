...
event3_intro()
{
	...
	level.squad["woods"] enable_cqbsprint();
	level.squad["hudson"] enable_cqbsprint();
...
event3_cavalry_arrives()
{
	...
	level.squad["woods"] disable_cqbsprint();
	level.squad["hudson"] disable_cqbsprint();
	level.squad["woods"] disable_cqbwalk();
	level.squad["hudson"] disable_cqbwalk();
...
tank_turret_pick_target( array_structs )
{
	...
	AssertEx( IsDefined( array_structs ), "array_structs is not defined");
	AssertEx( IsArray( array_structs ), "array_structs is not an array");	
